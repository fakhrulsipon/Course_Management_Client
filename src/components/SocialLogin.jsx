        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="font-medium text-sm dark:text-gray-600">Continue with Google</span>
            </button>
            ...
            >
              ...
              <span className="font-medium text-sm dark:text-gray-600">Continue with GitHub</span>
            </button>
          </div>
        </div>
    );
